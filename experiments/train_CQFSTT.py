...
from core.CQFSTT import CQFSTT
from core.CQFSTTTrainer import CQFSTTTrainer
...
def train_CQFSTT(
    ...
    for percentages, alphas, betas, combination_strengths, CF_recommender_class in iterable:
        ...
        CQFS_trainer = CQFSTTTrainer(CQFS_selector, URM_train, URM_validation, URM_train_validation, URM_test, ICM_train,
